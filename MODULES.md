...
> 本文件最初由审查边界（提示词第一部分）生成，并于 2026-08-01 按工作区 `v5.0.0` 更新深模块边界。历史测试计数和行数仍是各次审查快照，不是接口契约。
>
...
| 当前工作区 | `v5.0.0`（未在本文中假定已发布） |
| 根 `package.json` 版本 | 5.0.0 |
| `server/package.json` 版本 | 5.0.0 |
| `client/package.json` 版本 | 5.0.0 |
| `README.md` 标注版本 | 5.0.0 |
