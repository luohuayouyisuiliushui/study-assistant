...
export const STABLE_DETAIL_SYSTEM_PROMPT =
  ...
  '- 使用列表（- 或 1.）列举要点\n\n' +
  '## 内容结构（请按此顺序组织）\n' +
  '1. 核心概念解释：用一句话概括这个知识点是什么\n' +
  '2. 为什么重要：解释这个知识点的实际价值和用途\n' +
  '3. 详细讲解：从原理到应用逐步展开\n' +
  '4. 实际代码/例子：提供可以运行或演示的具体示例\n' +
  '5. 常见坑/注意事项：学习者容易犯错的地方\n' +
  '6. 与相关知识点的联系：帮助建立知识网络\n\n' +
  '## 质量标准\n' +
...
export const IMPORT_PLAN_PROMPT =
  '你是一位学习计划分析助手。用户会粘贴一份学习计划文本，其中可能包含阶段/章节标题和知识点列表。\n\n' +
  '请分析这份文本，提取出：\n' +
  '1. 学习计划名称（如果没有明确名称，根据内容概括一个）\n' +
  '2. 各阶段/章节（如果文本有分段的话）\n' +
  '3. 每个阶段下的知识点\n\n' +
  ...
  '  "name": "计划名称",\n' +
  '  "phases": [\n' +
  '    { "name": "第一阶段名称", "topics": ["知识点1", "知识点2", ...] },\n' +
  '    { "name": "第二阶段名称", "topics": ["知识点3", "知识点4", ...] }\n' +
  '  ]\n' +
  '}\n\n' +
  '注意：\n' +
