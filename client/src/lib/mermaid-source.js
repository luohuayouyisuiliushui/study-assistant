const STATE_DIAGRAM_HEADER = /^\s*stateDiagram(?:-v2)?\s*$/;
const QUOTED_STATE = '"(?:\\\\.|[^"\\\\])*"';
...
/**
 * Mermaid state transitions require identifiers, while AI output often uses
 * quoted display names directly. Declare stable aliases for those names and
 * use the aliases only at transition endpoints.
 */
